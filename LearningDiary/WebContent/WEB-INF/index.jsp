		...
		<div class="row">
			...
			<div class="col-md-8" id="row2">
				...
				<p style="text-align: justify; ">
					...
					<strong>What?</strong> One stop place to keep track of <u>takeaways</u>
					...
					differently. <br>
					<br> <strong>How?</strong> <u>Securely</u> organize and manage
					learnings in your personal online account. <br>
					<br> <strong>Why?</strong> <u>Reflections</u> of learnings from your
					reading gives you a very personal experience that can you go and
					revisit over time or reading them again. <br>
					<br>
					<u><a href="/LearningDiary/signup" style="color: blue;"> CLICK HERE TO SIGN-UP FOR FREE </a></u>
